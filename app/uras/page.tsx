        ...
        <main className="flex min-h-screen flex-col items-center justify-between md:p-24 p-8">
            <div className="flex flex-col items-center md:flex-row md:max-w-3xl md:p-0 pt-4">
                ...
                <div className="flex flex-col justify-between p-4 leading-normal">
                    ...
                    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Maok seribu tapi xmok polah seribu.<br /> <br />

                        Podcast tok di polah pake nulong orang Sarawak maju. Mun mok negara maju, start dari dirik lok. Ya la kita nega Uras, blajar cara urang Sarawak dikpun maju. <br /><br />

                        Episode baru setiap ari Senin.
                    </p>
            ...
            <div className="flex">
                <iframe src="https://podcasters.spotify.com/pod/show/uras3/embed/episodes/7-Kali-Gugok--Kali-ke-8-Bangun---dengan-Faizul--Uras-Pilot-Episode-0-e2jidmb" width="780px" className="hidden md:block"></iframe>

                <iframe src="https://podcasters.spotify.com/pod/show/uras3/embed/episodes/7-Kali-Gugok--Kali-ke-8-Bangun---dengan-Faizul--Uras-Pilot-Episode-0-e2jidmb" width="320px" className="md:hidden md:block"></iframe>
            </div>
